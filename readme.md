...
**Leaderboard**, is a tool used to keep track of the scores achieved by people while allowing scores to be ranked. The app features custom API calls to the leaderboard API and uses Webpack and Bootstrap.
...
cd my-folder
  git clone https://github.com/Ferizad/Leaderboard.git
